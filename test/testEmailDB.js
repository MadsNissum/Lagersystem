...
import { getEmail, addEmail, getEmails, deleteEmail } from '../database/emailDB.js'
...
describe('EmailDB Test', () => {
    ...
    describe('Get Emails Function', () => {
        it('Should return an array of correct emails', async () => {
            ...
            await deleteEmail(email1.id);
            await deleteEmail(email2.id);
            await deleteEmail(email3.id);
        });
    });
});
